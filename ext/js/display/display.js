...
<<<<<<< HEAD
            ...
            console.warn(isKanji, source, wildcardsEnabled, optionsContext, dictionaryEntries);
=======
            const {dictionaryEntries} = await yomichan.api.termsFind(source, findDetails, optionsContext);
>>>>>>> origin/master
            return dictionaryEntries;
...
<<<<<<< HEAD
        ...
        if (!run || !document.URL.includes('chrome-extension://ihneooeljjglhlfbnkflakdikdlncfao/s')) {
