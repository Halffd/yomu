...
// dev/lib/handlebars/src/visitor.ts
...
// dev/lib/handlebars/src/handlebars.ts
var Handlebars2 = require_handlebars();
var originalCreate = Handlebars2.create;
Handlebars2.create = function() {
  const SandboxedHandlebars = originalCreate.call(Handlebars2);
  SandboxedHandlebars.compileAST = Handlebars2.compileAST;
  return SandboxedHandlebars;
};
Handlebars2.compileAST = function(input, options) {
  if (input == null || typeof input !== "string" && input.type !== "Program") {
    throw new Handlebars2.Exception(
      `You must pass a string or Handlebars AST to Handlebars.compileAST. You passed ${input}`
    );
  }
  const visitor = new ElasticHandlebarsVisitor(this ?? Handlebars2, input, options);
  return (context, runtimeOptions) => visitor.render(context, runtimeOptions);
};
export {
  Handlebars2 as Handlebars
};
